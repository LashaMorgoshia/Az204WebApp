...
{
    public class DocRepo<T> where T : class
    {
        private static readonly string Endpoint = "https://cosmosdbapp1.documents.azure.com:443/";
        private static readonly string AuthKey = "ZpZngo2Z1rSEpkvtVCdDIulDWHrLyHKDMDWqpBFDC2o0BIrXdIVSicwIIooOKkxmF76uOEKwtskLh5kRZDXdaQ==";
